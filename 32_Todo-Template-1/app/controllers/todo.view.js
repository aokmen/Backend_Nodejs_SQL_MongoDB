...
const PRIORITY =  // önceden tanimlanmis sabit degerler büyük hafle yazilir
    {
      '1' : 'High',
      '0' : 'Normal',
      '-1' : 'Low',
...
module.exports = {
    ...
    list: async (req, res) => {
        ...
        //     isLogin:true
        // })
        res.render('todoList',{count:data.count, todos:data.rows, priority:PRIORITY})  //todos basligi adinda verileri getir
    },
